...
@section('content')
    ...
    <div class="card mb-4 border-0 shadow">
        <div class="card-header bg-primary border-0">
            <h4 class="mb-0 text-white">🧭 Tambah Paket Wisata</h4>
        </div>
        <div class="card-body">
            <div class="row">
                {{-- Sidebar Tab --}}
                            ...
                            <div class="tab-pane fade show active" id="tab-umum" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_jenis_paket" class="form-control" required>
                                        <option value="" disabled {{ old('id_jenis_paket') ? '' : 'selected' }}>Pilih
                                            jenis paket</option>
                                        @foreach ($jenisPaket as $jenis)
                                            <option value="{{ $jenis->id }}"
                                                {{ old('id_jenis_paket') == $jenis->id ? 'selected' : '' }}>
                                                {{ $jenis->nama_paket }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="durasi_hari" class="form-control"
                                            value="{{ old('durasi_hari') }}" required>
                                    </div>
                                    {{-- Jadwal Keberangkatan --}}
                                    <div class="form-group col-md-6">
                                        <label for="jadwal_keberangkatan">Jadwal Keberangkatan</label>
                                        <input type="datetime-local" name="jadwal_keberangkatan" class="form-control"
                                            value="{{ old('jadwal_keberangkatan') }}" required>
                            ...
                            <div class="tab-pane fade" id="tab-maps" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="maps" class="form-control"
                                        value="{{ old('maps') }}" placeholder="https://goo.gl/maps/..." required>
                                </div>
                                <div class="d-flex justify-content-between mt-3">
                                    <button type="button" class="btn btn-outline-warning"
                                ...
                                <div id="faq-container">
                                    ...
                                    @foreach ($faqs as $i => $faq)
                                        <div class="faq-row mb-3 rounded border p-3">
                                            ...
                                            <div class="form-group">
                                                <label>Jawaban</label>
                                                <textarea name="faqs[{{ $i }}][answer]" rows="2" class="form-control" required>{{ $faq['answer'] ?? '' }}</textarea>
                                            </div>
