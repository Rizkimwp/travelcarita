                ...
                <div class="col fill_height">
                    ...
                    <div class="search_tabs_container">
                        <div
                            ...
                            <div
                                class="search_tab active d-flex align-items-center justify-content-lg-center justify-content-start flex-row">
                                <img src="images/suitcase.png" alt=""><span>keluarga</span>
                            </div>

                            <div
                                class="search_tab d-flex align-items-center justify-content-lg-center justify-content-start flex-row">
                                <img src="images/diving.png" alt="">honeymoon
                            </div>
                        </div>
                    </div>
            ...
            <div class="row trending_container">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="trending_item clearfix">
                        <div class="trending_image"><img src="images/trend_1.png" alt="https://unsplash.com/@fransaraco">
                        </div>
                ...
                <div class="col-lg-3 footer_column">
                    <div class="footer_col">
                        <div class="footer_content footer_about">
                            ...
                            <p class="footer_about_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
                                quis vu lputate eros, iaculis consequat nisl. Nunc et suscipit urna. Integer eleme ntum orci
                                eu vehicula pretium.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 order-lg-1 order-2">
                    <div class="copyright_content d-flex align-items-center flex-row">
                ...
                <div class="col-lg-9 order-lg-2 order-1">
                    <div class="footer_nav_container d-flex align-items-center justify-content-lg-end flex-row">
